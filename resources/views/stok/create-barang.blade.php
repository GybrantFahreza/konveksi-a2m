...
<head>
    <meta charset="UTF-8">
    <title>Tambah Barang Jadi - Konveksi A2M</title>
    ...
    <style>
        * {
        ...
        .btn-tertiary-clear {
            ...
            color: #ffffff;
            box-shadow: 0 4px 12px rgba(30, 124, 0, 0.18);
        }

        .btn-tertiary-clear:hover {
...
<body class="font-body-main text-on-surface">
    ...
    <main class="min-h-screen transition-all bg-surface-bright">
        ...
        <div class="page-content pt-24 px-xl pb-xl space-y-lg">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-md">
                <div>
                    <div class="flex items-center gap-sm text-sm text-on-surface-variant mb-sm">
                        ...
                        <span class="text-primary font-bold">Tambah Barang Jadi</span>
                    </div>
                    ...
                    <p class="font-body-main text-on-surface-variant mt-xs max-w-2xl">
                        Masukkan data barang jadi yang sudah siap masuk gudang, seperti nama pakaian, ukuran, jumlah stok awal, dan satuan barang.
                    </p>
                </div>
            ...
            <!-- Form Card -->
            <form action="/stok/barang-jadi" method="POST" class="bg-surface-container-lowest border border-outline-variant rounded-xl soft-industrial-shadow overflow-hidden">
                @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-xl">
                        ...
                        <div class="lg:col-span-8 space-y-lg">
                            ...
                            <div class="space-y-sm">
                                <label class="font-heading-md text-sm text-on-surface flex items-center gap-xs" for="nama_barang">
                                    Nama Pakaian / Barang
                                ...
                                <input
                                    ...
                                    id="nama_barang"
                                    name="nama_barang"
                                    placeholder="Contoh: Seragam Batik SDN 12"
                                    type="text"
                                    required
                                    autofocus>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-lg">
                                ...
                                <!-- Ukuran -->
                                <div class="space-y-sm">
                                    <label class="font-heading-md text-sm text-on-surface flex items-center gap-xs" for="ukuran">
                                        Ukuran
                                        <span class="text-error">*</span>
                                    </label>
                                ...
                                <div class="space-y-sm sm:col-span-2">
                                    ...
                                    <input
                                        ...
                                        name="satuan"
                                        value="Pcs"
                                        placeholder="Contoh: Pcs, Lusin, Kodi"
                                        type="text"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="bg-surface-container-low p-md rounded-lg border border-outline-variant/60 flex gap-md items-start">
                                ...
                                <div>
                                    <h4 class="font-heading-md text-sm text-primary">
                                        Petunjuk Pengisian Barang Jadi
                                    </h4>

                                    <p class="font-caption text-on-surface-variant leading-relaxed mt-xs">
                                        Gunakan nama barang yang jelas agar mudah dicari di daftar stok. Kolom ukuran dapat diisi dengan satu ukuran tertentu seperti S, M, L, XL, atau ukuran lain sesuai kebutuhan produksi.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-4 space-y-lg">
                            <div class="bg-surface p-lg rounded-xl border border-outline-variant flex flex-col gap-md">
                                ...
                                <div class="preview-square aspect-square bg-surface-container-highest rounded-lg flex flex-col items-center justify-center text-center p-lg relative overflow-hidden group">
                                    ...
                                    <p class="font-body-data text-outline relative z-10 mt-xs" id="preview-size">
                                        Ukuran: -
                                    </p>
                                    ...
                                    <div class="mt-md relative z-10">
                                        <span class="px-3 py-1 bg-primary/10 text-primary text-[10px] font-bold rounded-full uppercase tracking-wider">
                                            Barang Jadi
                                        </span>
                                    </div>
                                </div>
                                ...
                                <p class="font-caption text-on-surface-variant text-center">
                                    Preview ini membantu memastikan data barang jadi mudah dibaca sebelum disimpan.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-actions px-xl py-lg bg-surface-container-low flex justify-end items-center gap-md">
                    ...
                    <button type="submit" class="px-xl py-md font-heading-md text-sm btn-tertiary-clear transition-all rounded-lg active:scale-95 flex items-center gap-xs">
    ...
    <script>
        ...
        function updatePreview() {
            const nama = namaBarangInput?.value.trim() || 'Belum Ada Nama';
            const ukuran = ukuranInput?.value.trim() || '-';
            const stok = stokInput?.value || '0';
            const satuan = satuanInput?.value.trim() || 'Pcs';
            ...
            if (previewSize) {
                previewSize.textContent = `Ukuran: ${ukuran}`;
            }
        ...
        [namaBarangInput, ukuranInput, stokInput, satuanInput].forEach((input) => {
            if (!input) return;
