...
<head>
    <meta charset="UTF-8">
    <title>Edit Barang Jadi - Konveksi A2M</title>
...
<body class="font-body-main text-on-surface">
    ...
    <main class="min-h-screen transition-all bg-surface-bright">
        ...
        <div class="page-content pt-24 px-xl pb-xl space-y-lg">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-md">
                <div>
                    <div class="flex items-center gap-sm text-sm text-on-surface-variant mb-sm">
                        ...
                        <span class="text-primary font-bold">Edit Barang Jadi</span>
                    </div>
                    ...
                    <p class="font-body-main text-on-surface-variant mt-xs max-w-2xl">
                        Perbarui data barang jadi yang tersimpan di gudang, seperti nama pakaian, ukuran, jumlah stok, dan satuan barang.
                    </p>
                </div>
            ...
            <!-- Form Card -->
            <form action="/stok/barang-jadi/{{ $barangJadi->id_barang }}" method="POST" class="bg-surface-container-lowest border border-outline-variant rounded-xl soft-industrial-shadow overflow-hidden">
                @csrf
                @method('PUT')
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-lg">
                                ...
                                <div class="space-y-sm">
                                    ...
                                    <input
                                        ...
                                        id="stok_sekarang"
                                        name="stok_sekarang"
                                        value="{{ $barangJadi->stok_sekarang }}"
                                        placeholder="0"
                                        min="0"
                                        type="number"
                                        required>
                            ...
                            <div class="bg-surface-container-low p-md rounded-lg border border-outline-variant/60 flex gap-md items-start">
                                ...
                                <div>
                                    <h4 class="font-heading-md text-sm text-primary">
                                        Petunjuk Edit Barang Jadi
                                    </h4>

                                    <p class="font-caption text-on-surface-variant leading-relaxed mt-xs">
                                        Pastikan perubahan data sudah sesuai dengan kondisi gudang. Jumlah stok yang diedit akan menjadi data terbaru yang muncul pada tabel stok barang jadi.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-4 space-y-lg">
                            <div class="bg-surface p-lg rounded-xl border border-outline-variant flex flex-col gap-md">
                                ...
                                <p class="font-caption text-on-surface-variant text-center">
                                    Preview ini membantu memastikan data barang jadi yang diedit sudah sesuai sebelum disimpan.
                                </p>
                            </div>
                        </div>
                    </div>
