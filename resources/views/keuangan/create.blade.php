...
<head>
    <meta charset="UTF-8">
    <title>Catat Arus Kas Baru - KONVEKSI A2M</title>
            ...
            <div class="w-full max-w-4xl mx-auto transition-all duration-300">
                ...
                <div class="bg-surface-container-lowest rounded-xl soft-industrial-shadow border border-outline-variant p-6 md:p-xl w-full">
                    ...
                    <div class="mb-xl border-b border-surface-container-high pb-lg text-left w-full">
                        <h2 class="font-nav-label text-2xl md:text-[32px] text-on-surface font-bold leading-tight text-left">Catat Arus Kas Baru</h2>
                        <p class="text-on-surface-variant mt-2 font-body-data text-sm md:text-base text-left">Masukkan detail transaksi produksi harian ke dalam sistem keuangan.</p>
                    </div>

                    <form action="/keuangan" method="POST" class="space-y-lg text-left">
                        @csrf

                        <div class="space-y-xs">
                            <label class="block font-heading-md text-on-surface text-sm md:text-base">Tanggal Transaksi</label>
                            <div class="relative">
                                <input class="w-full px-md py-3 border border-outline-variant rounded-lg font-body-data form-input-focus bg-surface-container-lowest appearance-none" type="date" name="tanggal_transaksi" value="{{ date('Y-m-d') }}" required>
                        ...
                        <div class="space-y-xs">
                            ...
                            <select class="w-full px-md py-3 border border-outline-variant rounded-lg font-body-data form-input-focus transition-all duration-200 font-bold" id="tipe_arus" name="tipe_arus" required>
                                <option value="Masuk" class="bg-emerald-50 text-emerald-700 font-bold">Pemasukan (Masuk)</option>
                                <option value="Keluar" class="bg-rose-50 text-rose-700 font-bold">Pengeluaran (Keluar)</option>
                            </select>
                        </div>

                        <div class="space-y-xs">
                            <label class="block font-heading-md text-on-surface text-sm md:text-base">Kategori (Contoh: Beli Bahan, DP Klien, Listrik)</label>
                            <input class="w-full px-md py-3 border border-outline-variant rounded-lg font-body-data form-input-focus bg-surface-container-lowest" placeholder="Contoh: Beli Bahan Kain Drill" type="text" name="kategori" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-lg">
                            <div class="space-y-xs">
                                ...
                                <input class="w-full px-md py-3 border border-outline-variant rounded-lg font-body-data form-input-focus bg-surface-container-lowest" min="1" type="number" name="banyak" value="1" required>
                            </div>
                            <div class="space-y-xs">
                                ...
                                <div class="relative">
                                    ...
                                    <input class="w-full pl-12 pr-md py-3 border border-outline-variant rounded-lg font-body-data form-input-focus bg-surface-container-lowest" placeholder="150000" type="number" name="harga" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-xs">
                            ...
                            <select class="w-full px-md py-3 border border-outline-variant rounded-lg font-body-data form-input-focus transition-all duration-200 font-bold" id="status_transaksi" name="status_transaksi" required>
                                <option value="Lunas" class="bg-emerald-50 text-emerald-700 font-bold">Lunas (Selesai)</option>
                                <option value="Belum Lunas" class="bg-rose-50 text-rose-700 font-bold">Belum Lunas (Tempo)</option>
                            </select>
                        </div>

                        <div class="space-y-xs">
                            <label class="block font-heading-md text-on-surface text-sm md:text-base">Keterangan / Deskripsi (Opsional)</label>
                            <textarea class="w-full px-md py-md border border-outline-variant rounded-lg font-body-data form-input-focus bg-surface-container-lowest resize-none" placeholder="Tulis rincian di sini..." rows="4" name="deskripsi"></textarea>
                        </div>
                ...
                <div class="mt-xl grid grid-cols-1 sm:grid-cols-2 gap-lg w-full text-left">
                    <div class="p-lg bg-secondary-container/10 border border-secondary-container/30 rounded-xl flex items-start gap-md">
                        ...
                        <div>
                            <p class="font-heading-md text-secondary text-sm md:text-base">Verifikasi Otomatis</p>
                            <p class="text-[12px] text-on-surface-variant leading-relaxed">Setiap transaksi akan diverifikasi oleh sistem audit internal sebelum masuk ke laporan bulanan.</p>
                        </div>
                    </div>
                    <div class="p-lg bg-surface-container-high rounded-xl flex items-start gap-md">
                        ...
                        <div>
                            <p class="font-heading-md text-on-surface text-sm md:text-base">Log Keamanan</p>
                            <p class="text-[12px] text-on-surface-variant leading-relaxed">Perubahan data ini akan dicatat atas nama Admin Utama pada tanggal 16 Mei 2026.</p>
                        </div>
                    </div>
                </div>
